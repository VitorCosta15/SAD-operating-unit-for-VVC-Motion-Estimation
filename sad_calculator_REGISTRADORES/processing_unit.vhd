...
port(
	clock : in std_logic;
	linha_memoria_CTB : in std_logic_vector (2047 downto 0); --256 Bytes -> 256 amostras -> alimentar 64 sads 4x4 -> levar 17 ciclos para obter todos os SADs
...
Architecture arch_processing_unit of processing_unit is
	...
	Component sads4x4_paralelizadas is
		port(
			clock : in std_logic;
			linha_memoria_CTB : in std_logic_vector (2047 downto 0); 
			linha_memoria_bloco_candidato : in std_logic_vector (2047 downto 0);
