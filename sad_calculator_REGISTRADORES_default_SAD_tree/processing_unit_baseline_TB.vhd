...
Entity processing_unit_baseline_TB is
End processing_unit_baseline_TB;

Architecture arch_processing_unit_baseline_TB of processing_unit_baseline_TB is
	...
	Component processing_unit_baseline is
	port(
		clock : in std_logic;
		linha_memoria_CTB : in std_logic_vector (8191 downto 0); --256 Bytes -> 256 amostras -> alimentar 64 sads 4x4 -> levar 18 ciclos para obter todos os SADs
...
Begin
	arch: processing_unit_baseline port map (clock => clock,
...
End arch_processing_unit_baseline_TB;