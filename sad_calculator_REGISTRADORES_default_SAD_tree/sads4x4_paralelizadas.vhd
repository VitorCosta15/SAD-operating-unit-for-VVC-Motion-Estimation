...
Architecture arch_sads4x4_paralelizadas of sads4x4_paralelizadas is
	...
	Component sad_calculator_baseline is --SUbtratores devem considerar bit sinal obviamente. Aqui chegam valores amostrais absolutos mas o resultado de uma subtração pode ser negativo, logo deve conter um circuito modular.
	...
	Port(
		...
		sad_saida : out std_logic_vector (11 downto 0)
	);
	End Component;
...
Begin
	...
	generate_4x4_SAD_trees: for i in 0 to 63 generate
		RSTC: sad_calculator_baseline generic map (N => 9) port map (clock => clock, clear => '0', 
		bloco_preditor_linha_1 => linha_memoria_CTB((128*i)+31 downto 128*i), --No baseline cada ciclo são 128 bits
		bloco_preditor_linha_2 => linha_memoria_CTB((128*i)+63 downto (128*i)+32),
		bloco_preditor_linha_3 => linha_memoria_CTB((128*i)+95 downto (128*i)+64),
		bloco_preditor_linha_4 => linha_memoria_CTB((128*i)+127 downto (128*i)+96),
		area_busca_linha_1 => linha_memoria_bloco_candidato((128*i)+31 downto 128*i),
		area_busca_linha_2 => linha_memoria_bloco_candidato((128*i)+63 downto (128*i)+32),
		area_busca_linha_3 => linha_memoria_bloco_candidato((128*i)+95 downto (128*i)+64),
		area_busca_linha_4 => linha_memoria_bloco_candidato((128*i)+127 downto (128*i)+96),
		sad_saida => matriz_de_sads(i));
	End generate;
